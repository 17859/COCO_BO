...
DIM = 20                     # Total ingredients (dimensions)
FILENAME = "chemical_sparse_data_f108_20d_20260115_1.csv" #我將FILENAME從f101改成f109_20260115
...
for i in range(N_SAMPLES):
    ...
    k = np.random.randint(low=2, high=6)
    k_counts.append(k)
