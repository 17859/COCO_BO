...
# 8. BO Loop
# ======================================================
print("🚀 Start BO (Noisy training / Noisefree evaluation)")
...
for i in range(N_ITER):
    ...
    ls = model.covar_module.base_kernel.lengthscale.detach().cpu().view(-1)
    relevance = 1.0 / ls

    ax1.clear()
    ax1.bar(range(dim), relevance.numpy())
    ax1.set_title(f"Iteration {i+1}: Relevance (1/Lengthscale)| ARD")
